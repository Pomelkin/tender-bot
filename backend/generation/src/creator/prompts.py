...
verdict_prompt = """Твоя задача - ответить, можно ли генерировать дополнительное соглашение или нет.

У тебя есть вердикт эксперта по закупкам. Если эксперт запретил создание дополнительного соглашения или признал его нежелательным, напиши "0". Если информация не найдена, нет четкого ответа, вердикт положительный или в любом другом случае напиши "1".
...
validation_query_prompt = "Возможно ли внести эти изменения: {0}?"